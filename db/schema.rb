...
ActiveRecord::Schema[7.2].define(version: 2024_10_05_103448) do
  ...
  create_table "assigned_training_plans", force: :cascade do |t|
    ...
    t.index ["profile_id"], name: "index_assigned_training_plans_on_profile_id"
    t.index ["training_plan_id"], name: "index_assigned_training_plans_on_training_plan_id"
  end
  ...
  create_table "training_plans", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["author_id"], name: "index_training_plans_on_author_id"
  end
